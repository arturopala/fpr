					...
					<div class="banner">
						<div class="banner_inner">
							<div class="banner_caption">
								<div class="banner_title">Las relaciones felices no nacen de los &#225;rboles</div>
								<div class="banner_subtitle">&#161;Inspire su matrimonio!</div>
							</div>
							<div class="banner_cta">
								<a href="<?php echo get_permalink( 11 ); ?>" class="btn-primary">Donaciones</a>
								<a href="<?php echo get_permalink( 3777 ); ?>" class="btn-secondary">&#218;nete</a>
							</div>
									...
									<div class="box box--primary">
										<div class="box_inner">
											...
											<div class="box_content">
												...
												<p><a href="<?php echo get_permalink( get_post_meta($post->ID, 'box_1_link', true) ); ?>">Leer m&#225;s</a></p>
											</div>
										</div>
									</div>
									...
									<div class="box box--primary">
										<div class="box_inner">
											...
											<div class="box_content">
												...
												<p><a href="<?php echo get_permalink( get_post_meta($post->ID, 'box_2_link', true) ); ?>">Leer m&#225;s</a></p>
											</div>
										</div>
									</div>
									...
									<div class="box box--primary">
										<div class="box_inner">
											...
											<div class="box_content">
												...
												<p><a href="<?php echo get_permalink( get_post_meta($post->ID, 'box_3_link', true) ); ?>">Leer m&#225;s</a></p>
											</div>
										</div>
									</div>
						...
						<div class="panel_inner">
								...
								<div class="row">
												...
												<?php while ($the_query -> have_posts()) : $the_query -> the_post(); ?>
													<div class="media">
														...
														<div class="media_body">
															...
															<div><a href="<?php the_permalink() ?>">Leer m&#225;s</a></div>
														</div>
													</div>
												<?php endwhile;?>
												<div class="article_cta">
													<a href="<?php get_category_link( 3734 ); ?>" class="btn-primary">Todas las noticias</a>
												</div>
									...
									<div class="col-4">
										...
										<div class="box article">
											<div class="box_inner">
												<h2>S&#237;ganos en YouTube</h2>
												<div id="youtube-channel">

												</div>
												<div class="article_cta">
													<a href="https://www.youtube.com/channel/UC0ek4TRBSJuwmMetApF4UHA" target="_blank" class="btn-primary">Mira m&#225;s</a>
												</div>
